...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔍 Group Owner', url='https://t.me/obana_i'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/obana_i')
            ],[
            InlineKeyboardButton('🤖 Dm to ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ', callback_data='clone')
            ],[
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 Grp Owner', url='https://t.me/obana_i'),
            InlineKeyboardButton('🤖 ᴄʜᴀɴɴᴇʟ owner', url='https://t.me/obana_i')
            ],[
            InlineKeyboardButton('🤖 Dm to ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ', callback_data='clone')
            ],[
            InlineKeyboardButton('💁‍♀️ ʜᴇʟᴘ', callback_data='help'),
